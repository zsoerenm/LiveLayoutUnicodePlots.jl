...
@testset "Helpers" begin
    @testset "get_kwargs_from_expr" begin
        ...
        kwargs = LiveUnicodePlots.get_kwargs_from_expr(expr)
    ...
    @testset "extract_width" begin
        ...
        expr = :(f(a, b; width=40, height=20))
        width = LiveUnicodePlots.extract_width(expr)
        @test width == 40
    ...
    @testset "extract_height" begin
        ...
        expr = :(f(a, b; width=40, height=20))
        height = LiveUnicodePlots.extract_height(expr)
        @test height == 20
    ...
    @testset "extract_title" begin
        ...
        title = LiveUnicodePlots.extract_title(expr)
        @test title == "Test"
